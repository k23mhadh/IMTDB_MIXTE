...
class ShowtimeStub(object):
    ...
    def __init__(self, channel):
        ...
        self.GetSchedule = channel.unary_unary(
                ...
                response_deserializer=showtime__pb2.ScheduleResponse.FromString,
                _registered_method=True)
        self.GetMoviesByDate = channel.unary_unary(
                '/Showtime/GetMoviesByDate',
                request_serializer=showtime__pb2.MoviesByDateRequest.SerializeToString,
                response_deserializer=showtime__pb2.MoviesByDateResponse.FromString,
                _registered_method=True)
...
def add_ShowtimeServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetSchedule': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=showtime__pb2.ScheduleResponse.SerializeToString,
            ),
            'GetMoviesByDate': grpc.unary_unary_rpc_method_handler(
                    servicer.GetMoviesByDate,
                    request_deserializer=showtime__pb2.MoviesByDateRequest.FromString,
                    response_serializer=showtime__pb2.MoviesByDateResponse.SerializeToString,
            ),
    }
...
class Showtime(object):
    ...
    def GetSchedule(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            showtime__pb2.ScheduleResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def GetMoviesByDate(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            target,
            '/Showtime/GetMoviesByDate',
            showtime__pb2.MoviesByDateRequest.SerializeToString,
            showtime__pb2.MoviesByDateResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
